...
#define HELIOS_RGB_BLOOD_ORANGE (uint32_t)0xFF1E00  // 255, 30, 0
...
#define HELIOS_RGB_CORAL_PINK (uint32_t)0xFF00B4    // 255, 0, 180
#define HELIOS_RGB_MAGENTA (uint32_t)0xFF003C       // 255, 0, 60

// Helios Medium Brightness Colors
#define HELIOS_RGB_WHITE_MEDIUM (uint32_t)0x000000         // 0, 0, 0
#define HELIOS_RGB_RED_MEDIUM (uint32_t)0x780000           // 120, 0, 0
#define HELIOS_RGB_BLOOD_ORANGE_MEDIUM (uint32_t)0x780E00  // 120, 14, 0
#define HELIOS_RGB_ORANGE_MEDIUM (uint32_t)0x781C00        // 120, 28, 0
#define HELIOS_RGB_YELLOW_MEDIUM (uint32_t)0x783800        // 120, 56, 0
#define HELIOS_RGB_LIME_GREEN_MEDIUM (uint32_t)0x297800    // 41, 120, 0
#define HELIOS_RGB_GREEN_MEDIUM (uint32_t)0x007800         // 0, 120, 0
#define HELIOS_RGB_SEAFOAM_MEDIUM (uint32_t)0x00781C       // 0, 120, 28
#define HELIOS_RGB_TURQUOISE_MEDIUM (uint32_t)0x007862     // 0, 120, 98
#define HELIOS_RGB_ICE_BLUE_MEDIUM (uint32_t)0x004E78      // 0, 78, 120
#define HELIOS_RGB_LIGHT_BLUE_MEDIUM (uint32_t)0x002178    // 0, 33, 120
#define HELIOS_RGB_BLUE_MEDIUM (uint32_t)0x000078          // 0, 0, 120
#define HELIOS_RGB_ROYAL_BLUE_MEDIUM (uint32_t)0x0D0078    // 13, 0, 120
#define HELIOS_RGB_PURPLE_MEDIUM (uint32_t)0x3D0078        // 61, 0, 120
#define HELIOS_RGB_PINK_MEDIUM (uint32_t)0x620078          // 98, 0, 120
#define HELIOS_RGB_CORAL_PINK_MEDIUM (uint32_t)0x780054    // 120, 0, 84
#define HELIOS_RGB_MAGENTA_MEDIUM (uint32_t)0x78001C       // 120, 0, 28

// Helios Low Brightness Colors
#define HELIOS_RGB_WHITE_LOW (uint32_t)0x000000         // 0, 0, 0
#define HELIOS_RGB_RED_LOW (uint32_t)0x3C0000           // 60, 0, 0
#define HELIOS_RGB_BLOOD_ORANGE_LOW (uint32_t)0x3C0700  // 60, 7, 0
#define HELIOS_RGB_ORANGE_LOW (uint32_t)0x3C0E00        // 60, 14, 0
#define HELIOS_RGB_YELLOW_LOW (uint32_t)0x3C1C00        // 60, 28, 0
#define HELIOS_RGB_LIME_GREEN_LOW (uint32_t)0x143C00    // 20, 60, 0
#define HELIOS_RGB_GREEN_LOW (uint32_t)0x003C00         // 0, 60, 0
#define HELIOS_RGB_SEAFOAM_LOW (uint32_t)0x003C0E       // 0, 60, 14
#define HELIOS_RGB_TURQUOISE_LOW (uint32_t)0x003C31     // 0, 60, 49
#define HELIOS_RGB_ICE_BLUE_LOW (uint32_t)0x00273C      // 0, 39, 60
#define HELIOS_RGB_LIGHT_BLUE_LOW (uint32_t)0x00103C    // 0, 16, 60
#define HELIOS_RGB_BLUE_LOW (uint32_t)0x00003C          // 0, 0, 60
#define HELIOS_RGB_ROYAL_BLUE_LOW (uint32_t)0x06003C    // 6, 0, 60
#define HELIOS_RGB_PURPLE_LOW (uint32_t)0x1E003C        // 30, 0, 60
#define HELIOS_RGB_PINK_LOW (uint32_t)0x31003C          // 49, 0, 60
#define HELIOS_RGB_CORAL_PINK_LOW (uint32_t)0x3C002A    // 60, 0, 42
#define HELIOS_RGB_MAGENTA_LOW (uint32_t)0x3C000E       // 60, 0, 14

// Helios Lowest Brightness Colors
#define HELIOS_RGB_WHITE_LOWEST (uint32_t)0x000000         // 0, 0, 0
#define HELIOS_RGB_RED_LOWEST (uint32_t)0x0A0000           // 10, 0, 0
#define HELIOS_RGB_BLOOD_ORANGE_LOWEST (uint32_t)0x0A0100  // 10, 1, 0
#define HELIOS_RGB_ORANGE_LOWEST (uint32_t)0x0A0200        // 10, 2, 0
#define HELIOS_RGB_YELLOW_LOWEST (uint32_t)0x0A0400        // 10, 4, 0
#define HELIOS_RGB_LIME_GREEN_LOWEST (uint32_t)0x030A00    // 3, 10, 0
#define HELIOS_RGB_GREEN_LOWEST (uint32_t)0x000A00         // 0, 10, 0
#define HELIOS_RGB_SEAFOAM_LOWEST (uint32_t)0x000A02       // 0, 10, 2
#define HELIOS_RGB_TURQUOISE_LOWEST (uint32_t)0x000A08     // 0, 10, 8
#define HELIOS_RGB_ICE_BLUE_LOWEST (uint32_t)0x00060A      // 0, 6, 10
#define HELIOS_RGB_LIGHT_BLUE_LOWEST (uint32_t)0x00020A    // 0, 2, 10
#define HELIOS_RGB_BLUE_LOWEST (uint32_t)0x00000A          // 0, 0, 10
#define HELIOS_RGB_ROYAL_BLUE_LOWEST (uint32_t)0x01000A    // 1, 0, 10
#define HELIOS_RGB_PURPLE_LOWEST (uint32_t)0x05000A        // 5, 0, 10
#define HELIOS_RGB_PINK_LOWEST (uint32_t)0x08000A          // 8, 0, 10
#define HELIOS_RGB_CORAL_PINK_LOWEST (uint32_t)0x0A0007    // 10, 0, 7
#define HELIOS_RGB_MAGENTA_LOWEST (uint32_t)0x0A0002       // 10, 0, 2

// Helios Medium Saturation Colors
#define HELIOS_RGB_WHITE_SATURATION_MEDIUM (uint32_t)0x000000         // 0, 0, 0
#define HELIOS_RGB_RED_SATURATION_MEDIUM (uint32_t)0xFF2222           // 255, 34, 34
#define HELIOS_RGB_BLOOD_ORANGE_SATURATION_MEDIUM (uint32_t)0xFF3C22  // 255, 60, 34
#define HELIOS_RGB_ORANGE_SATURATION_MEDIUM (uint32_t)0xFF5622        // 255, 86, 34
#define HELIOS_RGB_YELLOW_SATURATION_MEDIUM (uint32_t)0xFF8A22        // 255, 138, 34
#define HELIOS_RGB_LIME_GREEN_SATURATION_MEDIUM (uint32_t)0x6FFF22    // 111, 255, 34
#define HELIOS_RGB_GREEN_SATURATION_MEDIUM (uint32_t)0x22FF22         // 34, 255, 34
#define HELIOS_RGB_SEAFOAM_SATURATION_MEDIUM (uint32_t)0x22FF56       // 34, 255, 86
#define HELIOS_RGB_TURQUOISE_SATURATION_MEDIUM (uint32_t)0x22FFD7     // 34, 255, 215
#define HELIOS_RGB_ICE_BLUE_SATURATION_MEDIUM (uint32_t)0x22B3FF      // 34, 179, 255
#define HELIOS_RGB_LIGHT_BLUE_SATURATION_MEDIUM (uint32_t)0x2260FF    // 34, 96, 255
#define HELIOS_RGB_BLUE_SATURATION_MEDIUM (uint32_t)0x2222FF          // 34, 34, 255
#define HELIOS_RGB_ROYAL_BLUE_SATURATION_MEDIUM (uint32_t)0x3C22FF    // 60, 34, 255
#define HELIOS_RGB_PURPLE_SATURATION_MEDIUM (uint32_t)0x9422FF        // 148, 34, 255
#define HELIOS_RGB_PINK_SATURATION_MEDIUM (uint32_t)0xD822FF          // 216, 34, 255
#define HELIOS_RGB_CORAL_PINK_SATURATION_MEDIUM (uint32_t)0xFF22BE    // 255, 34, 190
#define HELIOS_RGB_MAGENTA_SATURATION_MEDIUM (uint32_t)0xFF2256       // 255, 34, 86

// Helios Low Saturation Colors
#define HELIOS_RGB_WHITE_SATURATION_LOW (uint32_t)0x000000         // 0, 0, 0
#define HELIOS_RGB_RED_SATURATION_LOW (uint32_t)0xFF5555           // 255, 85, 85
#define HELIOS_RGB_BLOOD_ORANGE_SATURATION_LOW (uint32_t)0xFF6955  // 255, 105, 85
#define HELIOS_RGB_ORANGE_SATURATION_LOW (uint32_t)0xFF7D55        // 255, 125, 85
#define HELIOS_RGB_YELLOW_SATURATION_LOW (uint32_t)0xFFA555        // 255, 165, 85
#define HELIOS_RGB_LIME_GREEN_SATURATION_LOW (uint32_t)0x90FF55    // 144, 255, 85
#define HELIOS_RGB_GREEN_SATURATION_LOW (uint32_t)0x55FF55         // 85, 255, 85
#define HELIOS_RGB_SEAFOAM_SATURATION_LOW (uint32_t)0x55FF7D       // 85, 255, 125
#define HELIOS_RGB_TURQUOISE_SATURATION_LOW (uint32_t)0x55FFE0     // 85, 255, 224
#define HELIOS_RGB_ICE_BLUE_SATURATION_LOW (uint32_t)0x55C4FF      // 85, 196, 255
#define HELIOS_RGB_LIGHT_BLUE_SATURATION_LOW (uint32_t)0x5584FF    // 85, 132, 255
#define HELIOS_RGB_BLUE_SATURATION_LOW (uint32_t)0x5555FF          // 85, 85, 255
#define HELIOS_RGB_ROYAL_BLUE_SATURATION_LOW (uint32_t)0x6855FF    // 104, 85, 255
#define HELIOS_RGB_PURPLE_SATURATION_LOW (uint32_t)0xAC55FF        // 172, 85, 255
#define HELIOS_RGB_PINK_SATURATION_LOW (uint32_t)0xE055FF          // 224, 85, 255
#define HELIOS_RGB_CORAL_PINK_SATURATION_LOW (uint32_t)0xFF55CD    // 255, 85, 205
#define HELIOS_RGB_MAGENTA_SATURATION_LOW (uint32_t)0xFF557D       // 255, 85, 125

// Helios Lowest Saturation Colors
#define HELIOS_RGB_WHITE_SATURATION_LOWEST (uint32_t)0x000000         // 0, 0, 0
#define HELIOS_RGB_RED_SATURATION_LOWEST (uint32_t)0xFF7D7D           // 255, 125, 125
#define HELIOS_RGB_BLOOD_ORANGE_SATURATION_LOWEST (uint32_t)0xFF8C7D  // 255, 140, 125
#define HELIOS_RGB_ORANGE_SATURATION_LOWEST (uint32_t)0xFF9B7D        // 255, 155, 125
#define HELIOS_RGB_YELLOW_SATURATION_LOWEST (uint32_t)0xFFBA7D        // 255, 186, 125
#define HELIOS_RGB_LIME_GREEN_SATURATION_LOWEST (uint32_t)0xAAFF7D    // 170, 255, 125
#define HELIOS_RGB_GREEN_SATURATION_LOWEST (uint32_t)0x7DFF7D         // 125, 255, 125
#define HELIOS_RGB_SEAFOAM_SATURATION_LOWEST (uint32_t)0x7DFF9B       // 125, 255, 155
#define HELIOS_RGB_TURQUOISE_SATURATION_LOWEST (uint32_t)0x7DFFE7     // 125, 255, 231
#define HELIOS_RGB_ICE_BLUE_SATURATION_LOWEST (uint32_t)0x7DD2FF      // 125, 210, 255
#define HELIOS_RGB_LIGHT_BLUE_SATURATION_LOWEST (uint32_t)0x7DA1FF    // 125, 161, 255
#define HELIOS_RGB_BLUE_SATURATION_LOWEST (uint32_t)0x7D7DFF          // 125, 125, 255
#define HELIOS_RGB_ROYAL_BLUE_SATURATION_LOWEST (uint32_t)0x8B7DFF    // 139, 125, 255
#define HELIOS_RGB_PURPLE_SATURATION_LOWEST (uint32_t)0xBF7DFF        // 191, 125, 255
#define HELIOS_RGB_PINK_SATURATION_LOWEST (uint32_t)0xE87DFF          // 232, 125, 255
#define HELIOS_RGB_CORAL_PINK_SATURATION_LOWEST (uint32_t)0xFF7DD8    // 255, 125, 216
#define HELIOS_RGB_MAGENTA_SATURATION_LOWEST (uint32_t)0xFF7D9B       // 255, 125, 155
...
#define HELIOS_RGB_BLOOD_ORANGE0 (uint32_t)0x190500  //  25   5   0
#define HELIOS_RGB_BLOOD_ORANGE1 (uint32_t)0x330B00  //  51  11   0
#define HELIOS_RGB_BLOOD_ORANGE2 (uint32_t)0x4C1000  //  76  16   0
#define HELIOS_RGB_BLOOD_ORANGE3 (uint32_t)0x661500  // 102  21   0
#define HELIOS_RGB_BLOOD_ORANGE4 (uint32_t)0x7F1B00  // 127  27   0
#define HELIOS_RGB_BLOOD_ORANGE5 (uint32_t)0x992000  // 153  32   0
#define HELIOS_RGB_BLOOD_ORANGE6 (uint32_t)0xB32600  // 179  38   0
#define HELIOS_RGB_BLOOD_ORANGE7 (uint32_t)0xCC2B00  // 204  43   0
#define HELIOS_RGB_BLOOD_ORANGE8 (uint32_t)0xE63000  // 230  48   0
#define HELIOS_RGB_BLOOD_ORANGE9 (uint32_t)0xFF1E00  // 255  30   0
...
#define HELIOS_RGB_CORAL_PINK0 (uint32_t)0x190025  //   25   0  37
#define HELIOS_RGB_CORAL_PINK1 (uint32_t)0x33004B  //   51   0  75
#define HELIOS_RGB_CORAL_PINK2 (uint32_t)0x4C0070  //   76   0 112
#define HELIOS_RGB_CORAL_PINK3 (uint32_t)0x660096  //  102   0 150
#define HELIOS_RGB_CORAL_PINK4 (uint32_t)0x7F00BB  //  127   0 187
#define HELIOS_RGB_CORAL_PINK5 (uint32_t)0x9900E1  //  153   0 225
#define HELIOS_RGB_CORAL_PINK6 (uint32_t)0xB300FF  //  179   0 255
#define HELIOS_RGB_CORAL_PINK7 (uint32_t)0xCC00FF  //  204   0 255
#define HELIOS_RGB_CORAL_PINK8 (uint32_t)0xE600FF  //  230   0 255
#define HELIOS_RGB_CORAL_PINK9 (uint32_t)0xFF00B4  //  255   0 180
