...
// Helios Full Brightness Colors
#define HELIOS_FULL_RGB_RED (uint32_t)0xFF0000           // 255, 0, 0
#define HELIOS_FULL_RGB_BLOOD_ORANGE (uint32_t)0xFF1E00  // 255, 30, 0
#define HELIOS_FULL_RGB_ORANGE (uint32_t)0xFF3C00        // 255, 60, 0
#define HELIOS_FULL_RGB_YELLOW (uint32_t)0xFF7800        // 255, 120, 0
#define HELIOS_FULL_RGB_LIME_GREEN (uint32_t)0x59FF00    // 89, 255, 0
#define HELIOS_FULL_RGB_GREEN (uint32_t)0x00FF00         // 0, 255, 0
#define HELIOS_FULL_RGB_SEAFOAM (uint32_t)0x00FF3C       // 0, 255, 60
#define HELIOS_FULL_RGB_TURQUOISE (uint32_t)0x00FFD1     // 0, 255, 209
#define HELIOS_FULL_RGB_ICE_BLUE (uint32_t)0x00A7FF      // 0, 167, 255
#define HELIOS_FULL_RGB_LIGHT_BLUE (uint32_t)0x0047FF    // 0, 71, 255
#define HELIOS_FULL_RGB_BLUE (uint32_t)0x0000FF          // 0, 0, 255
#define HELIOS_FULL_RGB_ROYAL_BLUE (uint32_t)0x1D00FF    // 29, 0, 255
#define HELIOS_FULL_RGB_PURPLE (uint32_t)0x8300FF        // 131, 0, 255
#define HELIOS_FULL_RGB_PINK (uint32_t)0xD200FF          // 210, 0, 255
#define HELIOS_FULL_RGB_CORAL_PINK (uint32_t)0xFF00B4    // 255, 0, 180
#define HELIOS_FULL_RGB_MAGENTA (uint32_t)0xFF003C       // 255, 0, 60

// Helios Mid Brightness Colors
#define HELIOS_MID_RGB_RED (uint32_t)0x780000           // 120, 0, 0
#define HELIOS_MID_RGB_BLOOD_ORANGE (uint32_t)0x780E00  // 120, 14, 0
#define HELIOS_MID_RGB_ORANGE (uint32_t)0x781C00        // 120, 28, 0
#define HELIOS_MID_RGB_YELLOW (uint32_t)0x783800        // 120, 56, 0
#define HELIOS_MID_RGB_LIME_GREEN (uint32_t)0x2A7800    // 42, 120, 0
#define HELIOS_MID_RGB_GREEN (uint32_t)0x007800         // 0, 120, 0
#define HELIOS_MID_RGB_SEAFOAM (uint32_t)0x00781C       // 0, 120, 28
#define HELIOS_MID_RGB_TURQUOISE (uint32_t)0x007862     // 0, 120, 98
#define HELIOS_MID_RGB_ICE_BLUE (uint32_t)0x004F78      // 0, 79, 120
#define HELIOS_MID_RGB_LIGHT_BLUE (uint32_t)0x002178    // 0, 33, 120
#define HELIOS_MID_RGB_BLUE (uint32_t)0x000078          // 0, 0, 120
#define HELIOS_MID_RGB_ROYAL_BLUE (uint32_t)0x0E0078    // 14, 0, 120
#define HELIOS_MID_RGB_PURPLE (uint32_t)0x3E0078        // 62, 0, 120
#define HELIOS_MID_RGB_PINK (uint32_t)0x620078          // 98, 0, 120
#define HELIOS_MID_RGB_CORAL_PINK (uint32_t)0x780054    // 120, 0, 84
#define HELIOS_MID_RGB_MAGENTA (uint32_t)0x78001C       // 120, 0, 28
